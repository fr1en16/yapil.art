...
отчёта не искажали показатели сайта. Быстрые переключатели показывают данные за сегодня, вчера,
последние 3 дня и неделю; произвольный диапазон можно задать в полях дат.
