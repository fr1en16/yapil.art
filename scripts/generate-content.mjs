...
const cases = [
  ...
  [5, 'bebble', 'Bebble', '2022', 'Болгарский бренд детской косметики', ['Сайт'], 'Сделать сайт болгарского бренда детской косметики: состав, линейки, доверие родителей.', 'Снять вопросы о безопасности состава и довести до покупки.', 'https://media.yapil.art/case/bebble.37cd7c21ced41d75.webp?v=2'],
